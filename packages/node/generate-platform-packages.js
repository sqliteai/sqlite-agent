...
const PLATFORMS = [
  {
    ...
    os: ['darwin'],
    cpu: ['arm64'],
    description: 'SQLite Agent extension for macOS ARM64 (Apple Silicon)',
    binaryName: 'agent.dylib',
    artifactFolder: 'agent-macos-arm64',
  },
  {
    name: 'darwin-x86_64',
    os: ['darwin'],
    cpu: ['x64', 'ia32'],
    description: 'SQLite Agent extension for macOS x86_64 (Intel)',
    binaryName: 'agent.dylib',
    artifactFolder: 'agent-macos-x86_64',
  },
  {
    name: 'linux-arm64',
    os: ['linux'],
    cpu: ['arm64'],
    description: 'SQLite Agent extension for Linux ARM64 (glibc)',
    binaryName: 'agent.so',
    artifactFolder: 'agent-linux-arm64',
  },
  {
    name: 'linux-arm64-musl',
    os: ['linux'],
    cpu: ['arm64'],
    description: 'SQLite Agent extension for Linux ARM64 (musl)',
    binaryName: 'agent.so',
    artifactFolder: 'agent-linux-musl-arm64',
  },
  {
    name: 'linux-x86_64',
    os: ['linux'],
    cpu: ['x64', 'ia32'],
    description: 'SQLite Agent extension for Linux x86_64 (glibc)',
    binaryName: 'agent.so',
    artifactFolder: 'agent-linux-x86_64',
  },
  {
    name: 'linux-x86_64-musl',
    os: ['linux'],
    cpu: ['x64', 'ia32'],
    description: 'SQLite Agent extension for Linux x86_64 (musl)',
    binaryName: 'agent.so',
    artifactFolder: 'agent-linux-musl-x86_64',
  },
  {
    name: 'win32-x86_64',
    os: ['win32'],
    cpu: ['x64', 'ia32'],
    description: 'SQLite Agent extension for Windows x86_64',
    binaryName: 'agent.dll',
    artifactFolder: 'agent-windows-x86_64',
  },
];
...
function generatePackageJson(platform, version) {
  return {
    name: `@sqliteai/sqlite-agent-${platform.name}`,
    version: version,
    ...
    repository: {
      type: 'git',
      url: 'https://github.com/sqliteai/sqlite-agent.git',
...
function generateReadme(platform, version) {
  return `# @sqliteai/sqlite-agent-${platform.name}

${platform.description}

**Version:** ${version}

This is a platform-specific package for [@sqliteai/sqlite-agent](https://www.npmjs.com/package/@sqliteai/sqlite-agent).
